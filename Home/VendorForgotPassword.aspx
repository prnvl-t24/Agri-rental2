<%@ Page Title="" Language="C#" MasterPageFile="~/Home/HomeMasterPage.master" AutoEventWireup="true" CodeFile="VendorForgotPassword.aspx.cs" Inherits="Home_VendorForgotPassword" %>
   ...
   <style>
       ...
       <div class="container">
            <div class="forgot-container">
                <h4 class="text-center mb-4">Vendor Forgot Password</h4>
    ...
    <asp:RequiredFieldValidator ID="rfvAnswer" runat="server"
        ...
        CssClass="text-danger" Display="Dynamic" />
                ...
                <asp:Button ID="btnFetchPassword" runat="server" CssClass="btn btn-primary btn-block" Text="Get Password" OnClick="btnSubmit_Click" />

                <div class="text-center mt-3">
                    <a href="VendorLogin.aspx">Back to Login</a>
                </div>
